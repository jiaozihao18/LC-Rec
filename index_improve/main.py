...
def parse_args():
    parser = argparse.ArgumentParser(description="Index Training with Better Codebook Utilization")
    ...
    # 新增的改进参数
    parser.add_argument("--ema_decay", type=float, default=0.99, help="EMA decay rate for codebook update")
    parser.add_argument("--epsilon", type=float, default=1e-5, help="Small epsilon for numerical stability")
    parser.add_argument("--reset_threshold", type=float, default=1e-5, help="Threshold for codebook reset (unused codes)")
    parser.add_argument("--reset_interval", type=int, default=1000, help="Interval (steps) for codebook reset")
...
if __name__ == '__main__':
    ...
    args = parse_args()
    print("=================================================")
    print("RQ-VAE Training with Better Codebook Utilization")
    print("=================================================")
    print(args)
    print("=================================================")
    print(f"EMA Decay: {args.ema_decay}")
    print(f"Reset Threshold: {args.reset_threshold}")
